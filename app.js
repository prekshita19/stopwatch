...
function myfun1(val) {
  ...
  if (val == 0) {
    next_screen2.innerHTML =
      "C is the mother of all programming language and it is a structure based language.";
  } else if (val == 1) {
    next_screen2.innerHTML =
      "Java is a strongly typed object oriented programming language and its very powerful";
  } else {
    next_screen2.innerHTML =
      "Python is a interpreted based language and its easy to learn and its the best developing language";
  }
  v = 1;
}
var v1 = 0;
...
function timer() {
  if (v1 == 0) {
    ...
    document.querySelector(".clock").style.border = "1px solid gray";
    document.querySelector(".clock").style.borderRadius = "25px";
